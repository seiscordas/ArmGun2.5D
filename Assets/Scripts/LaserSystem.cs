...
public class LaserSystem : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        _isActiveAim = aimSystem.IsActiveAim;
    ...
    {
        return Player.GetComponent<Player3DController>()._facingRight;
    }
    private bool IsFliping()
    {
        return Player.GetComponent<Player3DController>()._isFliping;
    }
}
